...
set qt_cmake_path=%ENV_QT_PATH%\msvc2019\lib\cmake\Qt6
if not exist "%qt_cmake_path%" set qt_cmake_path=%ENV_QT_PATH%\msvc2019\lib\cmake\Qt5
...
if /i "%2"=="x64" (
    ...
    set qt_cmake_path=%ENV_QT_PATH%\msvc2019_64\lib\cmake\Qt6
    if not exist "%qt_cmake_path%" set qt_cmake_path=%ENV_QT_PATH%\msvc2019_64\lib\cmake\Qt5
)
