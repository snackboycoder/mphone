...
signals:
    void mirrorMouseInput(const QString &serial, QEvent::Type type, const QPointF &ratioPos,
                          Qt::MouseButton button, Qt::MouseButtons buttons, Qt::KeyboardModifiers modifiers);
    void mirrorWheelInput(const QString &serial, const QPointF &ratioPos, const QPoint &angleDelta,
                          Qt::MouseButtons buttons, Qt::KeyboardModifiers modifiers);
    void mirrorKeyInput(const QString &serial, QEvent::Type type, int key, Qt::KeyboardModifiers modifiers,
