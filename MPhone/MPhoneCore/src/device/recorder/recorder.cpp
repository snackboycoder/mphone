...
bool Recorder::open()
{
    ...
    QString comment = "Recorded by MPhone " + QCoreApplication::applicationVersion();
...
#ifdef MPHONE_LAVF_HAS_NEW_CODEC_PARAMS_API
...
{
#ifdef MPHONE_LAVF_HAS_NEW_MUXER_ITERATOR_API
