...
int main(int argc, char *argv[])
{
    // set env
#ifdef Q_OS_WIN32
    qputenv("MPHONE_ADB_PATH", "../../../MPhone/MPhoneCore/src/third_party/adb/win/adb.exe");
    qputenv("MPHONE_SERVER_PATH", "../../../MPhone/MPhoneCore/src/third_party/scrcpy-server");
    qputenv("MPHONE_CONFIG_PATH", "../../../config");
#endif

#ifdef Q_OS_MACOS
    qputenv("MPHONE_ADB_PATH", "../../../../../../MPhone/MPhoneCore/src/third_party/adb/mac/adb");
    qputenv("MPHONE_SERVER_PATH", "../../../../../../MPhone/MPhoneCore/src/third_party/scrcpy-server");
    qputenv("MPHONE_CONFIG_PATH", "../../../../../../config");
#endif
    ...
    if (qgetenv("MPHONE_ADB_PATH").isEmpty()) {
        qputenv("MPHONE_ADB_PATH", "../../../MPhone/MPhoneCore/src/third_party/adb/linux/adb");
    }
    if (qgetenv("MPHONE_SERVER_PATH").isEmpty()) {
        qputenv("MPHONE_SERVER_PATH", "../../../MPhone/MPhoneCore/src/third_party/scrcpy-server");
    }
    if (qgetenv("MPHONE_CONFIG_PATH").isEmpty()) {
        qputenv("MPHONE_CONFIG_PATH", "../../../config");
    }
#endif
    ...
    */
    ...
    QCoreApplication::setApplicationName("MPhone");
    QCoreApplication::setOrganizationName("MPhone");
    QCoreApplication::setOrganizationDomain("mphone.local");
    ...
    qInfo() << QString("MPhone %1").arg(QCoreApplication::applicationVersion());
